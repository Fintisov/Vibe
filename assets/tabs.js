class TabsComponent {
  ...
  onButtonClick(event) {
    ...
    let elem =  event.target.closest(this.options.tabList).querySelectorAll('.tabs-list__link');
    ...
    let activePanelId = anchorReference.getAttribute('data-href');
